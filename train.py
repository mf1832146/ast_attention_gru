...
if __name__ == '__main__':
    ...
    train_gen = DataGen(train_code_ids, train_ast_path, train_y, args.batch_size, ast_w2i, path=args.data_dir + '/tree/train/', nl_dict_len=config['com_vocab_size'])
    valid_gen = DataGen(valid_code_ids, valid_ast_path, valid_y, args.batch_size, ast_w2i, path=args.data_dir + '/tree/valid/', nl_dict_len=config['com_vocab_size'])
